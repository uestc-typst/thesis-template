...
#let 独创性声明和论文使用授权(info: (:)) = [
  ...
  #block(
    ...
    #align(right)[作者签名：#fixed-width-underline(width: 7em, "") 日期：#fixed-width-space(2em)年#fixed-width-space(2em)月#fixed-width-space(2em)日]
  ]
  ...
  #block(
    ...
    #align(right)[作者签名：#fixed-width-underline(width: 7em, "") 导师签名：#fixed-width-underline(width: 7em, "")]
