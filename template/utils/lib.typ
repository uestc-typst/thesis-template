...
#import "heading.typ": (
  set-global-heading, set-中文摘要-heading, set-参考文献-heading, set-攻读学位期间获取成果-heading, set-正文-heading,
  set-目录-heading, set-致谢-heading, set-英文摘要-heading, set-附录-heading,
)

#import "page.typ": (
  set-global-page, set-中文摘要-page, set-参考文献-page, set-攻读学位期间获取成果-page, set-正文-page, set-目录-page,
  set-致谢-page, set-英文摘要-page, set-附录-page,
)
